...
describe('handlers', () => {
    ...
    describe('getAddressHandler', () => {
        ...
        it('should return correct address with index from getAddressHandler', async () => {
            ...
            expect(mockJson).toHaveBeenCalledWith({
                address: '0xCA12337b576cC4B328a4Ac8F77E6326929660dc8',
            });
        });
    });
    ...
    describe.only('sendUserOpHandler', () => {
        it.only(
            'should send a user operation and return a receipt',
            async () => {
                mockRequest.body = {
                    address: '0xf39fd6e51aad88f6f4ce6ab8827279cfffb92266',
                    projectId: process.env.ZERODEV_PROJECT_ID,
                ...
                const userOperation: UserOperation =
                    mockJson.mock.calls[0][0].userOperation;

                const signer = privateKeyToAccount(privateKey);

                userOperation.signature = ('0x00000000' +
                    (
